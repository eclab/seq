...
\paragraph{Notes and Events} The Notes object supports several kinds of events: Notes, Pitch Bend, CC, Aftertouch, RPN, and NRPN.  If you select an event, its inspector pops up.  All events have a time of onset called {\bf When}.  You can change this value, but you must press {\bf Set} to set it, because it will change the order of the note in the list.  Additionally:
