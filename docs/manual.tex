...
You select the algorithm at right.  The main part of the motif then has three parts:

\begin{itemize}
\item {\it (At Left)} The parameters of the algorithm.  In the image above, the parameters shown are for the Triadex Muse.
