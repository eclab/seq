...
\large\rm {\bf Manual Version 9.0}\\
\large\rm  January 2026\\
...
In the immediate future, we'll be adding external sync, a dark mode, interface improvements, and more MIDI file generation.
