...
\item {\bf Add to Length}\qquad If checked, then you can {\it add to} the length of notes rather than {\it set} their length.  Note that {\bf Change Length} must still be checked. 
\end{itemize}
