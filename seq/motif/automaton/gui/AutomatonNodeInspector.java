...
*/
	...
	static final String MOTIF_INITIAL_REPEATS_TOOLTIP = "<html><b>Repeat Probability</b><br>" +
	...
	static final String MOTIF_REPEAT_PROBABILITY_TOOLTIP = "<html><b>Initial Repeats</b><br>" +
		"Sets how often the motif node will repeat before transitioning to the next node.<br><br>" + 
		"Repeating works as follows:" +
		"<ol>" +
		"<li>The motif node is played once." +
