...
public class Joystick extends JComponent
    ...
    public void setXPos(double val) { xPos = val; }
    public void setYPos(double val) { yPos = val; }
    public double getXPos() { return xPos; }
    public double getYPos() { return yPos; }
        
    public Dimension getMinimumSize()
        {
        return new Dimension((int)(256 + JOYSTICK_WIDTH+ STROKE_WIDTH+ margin), (int)(256 + JOYSTICK_WIDTH+ STROKE_WIDTH+ margin));
        }
